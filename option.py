...
# Data specifications
parser.add_argument('--dir_data', type=str, default='./remote_sensing/Data', ###
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='AID',       ###
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='WHU_RS19',   ###
                    help='test dataset name')
parser.add_argument('--data_range', type=str, default='1-10000/801-810',
...
parser.add_argument('--blur_kernel', type=int, default=21,  ### default=21,
...
parser.add_argument('--sig', type=float, default=4.0,                   ###SIG = 0 bicubic
...
parser.add_argument('--lr_decay_sr', type=int, default=116,              ###
                    help='learning rate decay per N epochs')

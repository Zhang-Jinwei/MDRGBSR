...
# path = 'F:\\'
# filename='2.png'    #要裁剪的图片名
# cols=256        #小图片的宽度（列数）
# rows=256        #小图片的高度（行数）
# clip_one_picture(path,filename,256,256)
# 裁剪所得12列图片，6行图片.
# 裁剪完成，得到72张图片.
# 裁剪所得图片的存放地址为：G:\01-dataset\tmp\\crop256_256\
...
"""调用合并图片的代码"""
merge_path="/home/damon/Downloads/SwinIR-main/SwinIR-main/results/swinir_classical_sr_x4/Gaofen-2"   #要合并的小图片所在的文件夹
num_of_cols=5    #列数
num_of_rows=7     #行数

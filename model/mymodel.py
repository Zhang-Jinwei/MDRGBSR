...
class MSRB_Block(nn.Module):
    ...
    def forward(self, x):
        ...
        input_2 = torch.cat([output_3_1, output_5_1], 1)#[8,128,256,256]
        ...
        output = torch.cat([output_3_2, output_5_2], 1)#[8,256,256,256]
...
def main():
    pass
    input = [torch.Tensor(8, 8, 64, 256, 256).cuda(), torch.Tensor(8, 64)]
